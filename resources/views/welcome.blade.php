        ...
        <div class="border py-5 px-2 rounded-lg max-w-[60%] mx-auto">
            <div class="px-3">
                ...
                <div class="flex flex-col items-center gap-y-2">
                    ...
                    <p class="px-10 text-center text-sm"><span class="font-bold text-blue-400">AttendEase</span> streamlines attendance tracking and school management in one easy-to-use platform.</p>
